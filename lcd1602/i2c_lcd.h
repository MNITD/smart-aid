...
#define lcd_pause	TIM6delay_us(1000) // а тут указать значение задержки
#define lcd_pause_short	TIM6delay_us(40) // а тут указать значение задержки

#define lcd_pause	delay(1000) // а тут указать значение задержки
#define lcd_pause_short	delay(40) // а тут указать значение задержки
